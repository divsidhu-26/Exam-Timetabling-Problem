...
class Period{		// assuming length of every period is same
	...
	public Period(int id,int session){
		...
		room[0] = new Room(0,1550);
		// room[0] = new Room(0,480);
		...
		// room[7] = new Room(7,65);
		// room[8] = new Room(8,58);
		// room[9] = new Room(9,50);
		// room[10] = new Room(10,40);
		// room[11] = new Room(11,40);
		// room[12] = new Room(12,35);
		// room[13] = new Room(13,30);
		// room[14] = new Room(14,25);
		// room[15] = new Room(15,6);
	}
		...
		do{
			...
			for(int i=0;i<num_periods;i++){
				...
				for(int j=i+1;j<num_periods;j++){
					Period change = period[j];
					List<Exam> dummy_exam_change = current.exams;
					Iterator<Exam> iter_exam_swap = dummy_exam.iterator();
					while(iter_exam_swap.hasNext()){
