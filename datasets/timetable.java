...
class timetable{
	...
	public static void main(String[] args){
		...
		try{
			BufferedWriter bw_students = new BufferedWriter(new FileWriter(args[3]));
			BufferedWriter bw_exams = new BufferedWriter(new FileWriter(args[4]));
			BufferedWriter bw_timetable = new BufferedWriter(new FileWriter(args[5]));
			for(int i=0;i<num_periods;i++){
				// System.out.println("Period "+i+": ");
